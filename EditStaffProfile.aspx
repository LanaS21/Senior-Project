...
<body>
    <form id="form1" runat="server">
                    ...
                    <div class="r22 justify-content-center">
                        ...
                        <div class="col-md-4 form-group" style="text-align: left;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="Birthdate"
                                ForeColor="Red" runat="server" ErrorMessage="Please enter the birth date"></asp:RequiredFieldValidator>
                    ...
                    <div class="r22 justify-content-center">
                        ...
                        <div class="col-md-4 form-group mt-3 mt-md-0" style="text-align: left;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="phoneNumber"
                                ForeColor="Red" runat="server" ErrorMessage="Please enter the phone number"></asp:RequiredFieldValidator>
                    ...
                    <div class="r22 justify-content-center">
                        ...
                        <div class="col-md-4 form-group mt-3 mt-md-0" style="text-align: left;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="Role"
                                ForeColor="Red" runat="server"
                                ErrorMessage="Please Select the role"></asp:RequiredFieldValidator>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="false" class="PoupupMsg">
            ...
            <img src="check.png" width="70" alt="check" />
            <pre> </pre>
