                                ...
                                <div class="categories-area section-padding30">
                                    ...
                                    <div class="container align-items-center">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4" onclick="location.href='../StaffPages/StaffAttendance.aspx';">
                                                <div class="single-cat mb-50">
                                                    <div class="cat-icon">
                                                        <span class="fa-solid fa-user-check"></span>
                                                    </div>
                                                    <div class="cat-cap">
                                                        <h5><a href="../StaffPages/StaffAttendance.aspx">Attendance</a></h5>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="col-lg-4 col-md-4 col-sm-4" onclick="location.href='../StaffPages/StudentProfilesByStaff.aspx';">
                                                <div class="single-cat mb-50">
                                                    <div class="cat-icon">
                                                        <span class="fa-solid fa-address-book"></span>
                                                    </div>
                                                    <div class="cat-cap">
                                                        <h5><a href="../StaffPages/StudentProfilesByStaff.aspx">Student Profiles</a></h5>
                                                    </div>
                                                </div>
                                            </div>
