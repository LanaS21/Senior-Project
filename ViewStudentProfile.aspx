<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewStudentProfile.aspx.cs" Inherits="ViewStudentProfile" %>
...
<hr />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:Button ID="Button3" class="button3" runat="server" Text="Delete" OnClick="Button3_Click" />
                                            </div>
                                        </div>
 ...
 <img src="check.png" width="70" alt="" />
            ...
            <asp:Button ID="Button2" runat="server" Text="Yes" OnClick="Button2_Click" /><asp:Button OnClick="Button5_Click" ID="Button5" runat="server" Text="No" />
        ...
        <!-- End Footer -->
           <script>
               function show_popup() {
                   document.getElementById('popup').classList.add('PoupupMsg');
               }
               function show_popup1() {
                   document.getElementById("popup").classList.remove('PoupupMsg');
               }
               function hide_popup() {
                   document.getElementById('popup').classList.remove('PoupupMsg');
