...
<body>
  ...
  <section id="main" style="background-color: rgb(244, 248, 249)">
    ...
    <div class="carousel-item active" >
          ...
          <div class="categories-area section-padding50"> <!-- this in style1.css -->
            <div class="container align-items-center">
              ...
              <div class="row justify-content-sm-center" >
                <div class="col-lg-4 col-md-4 col-sm-4" onclick="location.href='GenerateSchedules.aspx';">
                  <div class="single-cat mb-10">
                    <div class="cat-icon">
                      <span class="fa-regular fa-calendar-plus"></span>
                    </div>
                    <div class="cat-cap">
                      <h5><a href="GenerateSchedules.aspx">Generate Schedules</a></h5>
                    </div>
                  </div>
                </div>

                <div class="col-lg-4 col-md-4 col-sm-4" onclick="location.href='ManageSchedules.aspx';">
                  <div class="single-cat mb-50">
                    <div class="cat-icon">
                      <span class="fa-solid fa-pen-to-square"></span>
                    </div>
                    <div class="cat-cap">
                      <h5><a href="ManageSchedules.aspx">Manage Schedules</a></h5>
                    </div>
                  </div>
                </div>
              </div> <!-- end row-->
